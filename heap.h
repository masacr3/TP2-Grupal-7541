...
/*
 * Implementación de un TAD cola de prioridad, usando un min-heap.
 *
 * Notar que al ser un min-heap el elemento mas chico será el de mejor
 * prioridad. Si se desea un max-heap, alcanza con invertir la función de
 * comparación.
 */
...
/* Devuelve el elemento con mínima prioridad. Si el heap esta vacío, devuelve
 * NULL.
 * Pre: el heap fue creado.
 */
void *heap_ver_min(const heap_t *heap);

/* Elimina el elemento con míniima prioridad, y lo devuelve.
